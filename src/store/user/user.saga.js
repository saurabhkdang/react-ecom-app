...
export function* getSnapshotFromUserAuth(userAuth, additionlInformation){
    try {
        const userSnapshot = yield call(createUserDocumentFromAuth, userAuth, additionlInformation);
...
export function* signInAfterSignUp({payload: {user, additionlInformation}}){
    yield call(getSnapshotFromUserAuth, user, additionlInformation);
}
